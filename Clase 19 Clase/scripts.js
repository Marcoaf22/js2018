...
class Profesor extends Persona {
  ...
  saludar() {
    return `Hola, me llamo ${this.nombre} y soy profesor`;
  }

  static describirProfesor(profesor) {
    return `${profesor.datos} y soy profesor de ${profesor.materia} `;
  }
}

Profesor.prototype.propiedadEstatica = 2;

const juan = new Persona("Juan", "García", 25);
const marta = new Persona("Marta", "García", 35);
const luis = new Profesor("luis", "lozada", 25, "sociales");
...
console.log(Profesor.describirProfesor(luis));
